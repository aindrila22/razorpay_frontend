...
const Home = () => {
  const checkoutHandler = async (amount) => {
    ...
    const options = {
      ...
      image:
        "https://media.licdn.com/dms/image/C5603AQE0H4B0zxl_3w/profile-displayphoto-shrink_800_800/0/1597434368852?e=1677110400&v=beta&t=etMVVjIjhYiSaF_QKq80-vF6bBFz_sR39iChk1iS7b4",
      order_id: order.id,
